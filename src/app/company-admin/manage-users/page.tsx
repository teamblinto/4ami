    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500">Company Admin / Manage Users</p>
        </div>
        ...
        <table className="min-w-full border-collapse">
          ...
          <tbody>
            ...
            {[
              ...
              { username: 'Jaiden_Nixon@2025', firstName: 'Jaiden', lastName: 'Nixon', role: 'Admin', email: 'jaiden.n@gmail.com' },
              { username: 'ace.fo', firstName: 'Ace', lastName: 'Foster', role: 'User', email: 'ace.fo@yahoo.com' },
              { username: 'nikolai.schmidt', firstName: 'Nikolai', lastName: 'Schmidt', role: 'Admin', email: 'nikolai.schmidt1964@outlook.com' },
              { username: 'me.cc2', firstName: 'Clark', lastName: 'Clayton', role: 'Admin', email: 'me@clayton.com' },
              { username: 'Chen1997', firstName: 'Prince', lastName: 'Chen', role: 'User', email: 'prince.chen1997@gmail.com' },
              { username: 'Duran', firstName: 'Duran', lastName: 'Reece', role: 'User', email: 'reece@yahoo.com' },
              { username: 'anastasia.spring', firstName: 'Anastasia', lastName: 'Spring', role: 'Admin', email: 'anastasia.spring@mcdaniel12.com' },
              { username: 'Me.boyle', firstName: 'Matthew', lastName: 'Boyle', role: 'Admin', email: 'Me.boyle@gmail.com' },
              { username: 'Kailee.thomas', firstName: 'Kailee', lastName: 'Thomas', role: 'User', email: 'Kailee.thomas@gmail.com' },
            ].map((user, index) => {
