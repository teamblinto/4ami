  ...
  return (
    <div className="w-full">
      ...
      <div className="overflow-x-auto bg-white">
        <table className="w-full text-sm text-left border border-gray-200 text-black">
            ...
            {projects.map((p, i) => (
                ...
                >
                <td className="px-4 py-4 border border-gray-200 cursor-pointer">{p.id}</td>
                <td className="px-4 py-4 border border-gray-200 cursor-pointer">{p.type}</td>
                <td className="px-4 py-4 border border-gray-200 cursor-pointer">{p.time}</td>
      ...
      <div className="mt-3 text-right">
        <a href="#" className="text-red-500 text-sm hover:underline font-medium">
          View All Projects
        </a>
      </div>
    </div>
