        ...
        {activeTab === 'overview' && (
          <div className="bg-white rounded-lg p-6">
            ...
            <div className="flex items-center justify-end mt-10 space-x-3">
              <button onClick={() => router.push('/user-dashboard/projects')} className="px-4 py-2 border border-[#D0D5DD] rounded-md text-sm text-[#343A40] hover:bg-[#F8F9FA] cursor-pointer">Go back to all projects</button>
