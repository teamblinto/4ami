...
export default function UserProfilePage() {
  ...
  return (
    <div>
      <div>
        <h1 className="font-medium text-[#343A40] text-2xl">Profile</h1>
        <p className="text-[#6C757D] mt-2 font-normal ">Dashboard / Profile</p>
      </div>
              ...
              {isEditingName ? (
                ...
                <div className="text-center mb-4">
                  ...
                  <div className="text-sm text-gray-600 space-y-1">
                    <p>
                      <span className="font-medium">Job Title:</span> Senior
                      Leasing Manager
                    </p>
                    <p>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Update your personal details to keep your profile accurate and
                up to date
              </p>
            </div>
