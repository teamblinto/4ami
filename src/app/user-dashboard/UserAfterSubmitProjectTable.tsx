            ...
            {loading ? (
              <>
                {Array.from({ length: 3 }).map((_, rowIndex) => (
                  ...
                  >
                    <td colSpan={6} className="px-4 py-4 align-middle border border-[#D0D5DD]">
              ...
              <tr>
                <td colSpan={6} className="px-4 py-6 text-center text-red-600 text-sm border border-[#D0D5DD]">
                  {error}
                </td>
              </tr>
            ) : projects.length === 0 ? (
